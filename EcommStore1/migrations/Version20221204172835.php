 ...
 */
final class Version20221204172835 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, name, description, price, is_new_arrival, is_featured, is_special_offer, featured_image, is_best_seller FROM product');
        $this->addSql('DROP TABLE product');
        $this->addSql('CREATE TABLE product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, categories_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, price DOUBLE PRECISION NOT NULL, is_new_arrival BOOLEAN DEFAULT NULL, is_featured BOOLEAN DEFAULT NULL, is_special_offer BOOLEAN DEFAULT NULL, featured_image VARCHAR(255) DEFAULT NULL COLLATE BINARY, is_best_seller BOOLEAN DEFAULT NULL, CONSTRAINT FK_D34A04ADA21214B7 FOREIGN KEY (categories_id) REFERENCES categories (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO product (id, name, description, price, is_new_arrival, is_featured, is_special_offer, featured_image, is_best_seller) SELECT id, name, description, price, is_new_arrival, is_featured, is_special_offer, featured_image, is_best_seller FROM __temp__product');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categories_product (categories_id INTEGER NOT NULL, product_id INTEGER NOT NULL, PRIMARY KEY(categories_id, product_id))');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, name, description, price, is_new_arrival, is_featured, is_special_offer, featured_image, is_best_seller FROM product');
        $this->addSql('DROP TABLE product');
        $this->addSql('CREATE TABLE product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description CLOB NOT NULL, price DOUBLE PRECISION NOT NULL, is_new_arrival BOOLEAN DEFAULT NULL, is_featured BOOLEAN DEFAULT NULL, is_special_offer BOOLEAN DEFAULT NULL, featured_image VARCHAR(255) DEFAULT NULL, is_best_seller BOOLEAN DEFAULT NULL)');
        $this->addSql('INSERT INTO product (id, name, description, price, is_new_arrival, is_featured, is_special_offer, featured_image, is_best_seller) SELECT id, name, description, price, is_new_arrival, is_featured, is_special_offer, featured_image, is_best_seller FROM __temp__product');
        $this->addSql('DROP TABLE __temp__product');
        $this->addSql('DROP INDEX IDX_6970EB0FA76ED395');
        $this->addSql('DROP INDEX IDX_6970EB0F4584665A');
