 ...
 */
final class Version20221204011401 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_FB40D50DA21214B7');
        $this->addSql('DROP INDEX IDX_FB40D50D4584665A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__categories_product AS SELECT categories_id, product_id FROM categories_product');
        ...
        $this->addSql('INSERT INTO categories_product (categories_id, product_id) SELECT categories_id, product_id FROM __temp__categories_product');
        $this->addSql('DROP TABLE __temp__categories_product');
        ...
        $this->addSql('ALTER TABLE product ADD COLUMN is_new_arrival BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE product ADD COLUMN is_featured BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE product ADD COLUMN is_special_offer BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE product ADD COLUMN featured_image VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE product ADD COLUMN is_best_seller BOOLEAN DEFAULT NULL');
