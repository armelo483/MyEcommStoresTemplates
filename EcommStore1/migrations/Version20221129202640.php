 ...
 */
final class Version20221129202640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rayon (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__categories AS SELECT id, name, image FROM categories');
        ...
        $this->addSql('INSERT INTO categories (id, name, image) SELECT id, name, image FROM __temp__categories');
